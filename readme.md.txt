# House Rent Predictor (Tkinter GUI)

## Description
This is a beginner-friendly machine learning project to predict house rent based on *area, **number of bedrooms, and **bathrooms* using *Linear Regression*.  
